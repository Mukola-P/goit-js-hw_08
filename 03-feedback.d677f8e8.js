...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form");a.addEventListener("input",(0,e.default)(n,500)),a.addEventListener("submit",s);const r="feedback-form-state";let l={};function s(e){e.preventDefault();const t=e.target.elements,s=t.email.value,n=t.message.value;return""===n&&""===s?alert('Поля "email" та "message" мають бути заповнені!'):""===s?alert('Поле "email" мають бути заповнені!'):""===n?alert('Поле "message" мають бути заповнені!'):(l={email:s,message:n},console.log(l),a.reset(),void localStorage.removeItem(r))}function n(e){l[e.target.name]=e.target.value,localStorage.setItem(r,JSON.stringify(l))}function o(){let e=localStorage.getItem(r);e&&(e=JSON.parse(e),Object.entries(e).forEach(([e,t])=>{l[e]=t,a.elements[e].value=t}))}o();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw_08/03-feedback.d677f8e8.js.map