...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const n=document.querySelector("iframe"),o=new Vimeo.Player(n),r="videoplayer - current - time";function u(e){const t=e.seconds;localStorage.setItem(r,t)}function a(){const e=localStorage.getItem(r);o.setCurrentTime(e).then().catch(function(e){return e.name})}o.on("timeupdate",(0,e.default)(u,1e3)),o.on("play",(0,e.default)(a,1e3));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw_08/02-video.7658e138.js.map